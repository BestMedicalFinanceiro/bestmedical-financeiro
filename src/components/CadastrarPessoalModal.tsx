...
export function CadastrarPessoalModal({
  onFechar,
  onSucesso,
}: {
  onFechar: () => void;
  ...
  const { cadastrarPessoal } = useFinanceiroAuth();
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <form onSubmit={onSubmit} className="w-full max-w-sm rounded-lg bg-surface p-5 shadow-lg">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-text">Definir senha do Financeiro Pessoal</h2>
